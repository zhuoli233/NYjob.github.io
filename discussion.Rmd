...
There is still some limitation of the analysis. Since the restriction of the source of data, we only analysing the information of jobs in New York government. So, for more generalized result, the analysis of the job information in companies may be needed. Also, the data all comes from the recruitment information, which may be different from the real status after becoming an employee. So, further research may need to consider those limitations.


##Suggestion

1. People with higher educational backgrounds could have a high base salary in engineering and technology area in most cases. Also people in these two job categories have the highest average salary. If you are interested in these areas, higher degree is recommended.   
2. The number of positions is increasing during these years, especially in health and engineering area. If you want to find a job, you will have more opportunity in these areas if you have the corresponding background.   
3. Most jobs preferred related experience and strong written ability. It is important to develop written skills and build more related experience in order to find a good job.
